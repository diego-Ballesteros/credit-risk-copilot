...
This module holds facts, never behaviour. It declares three separate things that are
...
data holds codes the source never documented. That gap is the finding; closing it here
would delete the finding instead of reporting it. Whatever gets decided about those codes
belongs in an ADR and in the preprocessing step, never in this map.
